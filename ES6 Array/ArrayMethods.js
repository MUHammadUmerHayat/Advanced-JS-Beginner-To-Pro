...
var a = []
console.log(a.push("Muhammad", "aslam"))
console.log(a)
console.log(a.pop())
console.log(a)
var b = []
...
console.log(b.shift())
console.log(b)
var arr =["Muhammad", "aslem", "aslam", "mahnoor", "parent", "cake"]
...
var a = ["Muhammad", "aslam", "kamran", "anas", "imran", "rabia"]
console.log(a.sort())
console.log(a.reverse()) */

//---------------------------------------CONCAT

var ab = ["Muhammad", "aslam", "imran"]
var ac = ["kamran", "aslam", "imran"]
var bc = ab.concat(ac)
console.log(bc)